...
namespace TelviSoft.Enterprise.Connectors.PowerConnector
{
    /// <summary>
    /// Interface que expone los métodos o funciones que permiten realizar eficazmente de forma masiva o individual operaciones a una fuente de datos.
    /// </summary>
    public interface IPowerConnector : IDisposable
    {
